...
Question.create(
    [
        ...
        {title: 'メルボルンで誕生日を祝えるお店を教えて下さい', body: 'メルボルンに来週行くのですが、一緒に行く人が誕生日なので
            ...
            よろしくおねがいします！！！', user_id: 16,country_id: 144, tag_id: 4,best_answer_id: 33},
        {title: 'アレルギー（卵、小麦、牛乳）持ち幼児の食事について', body: '旅行時に１歳８か月の子供とメルボルンの友人宅へ遊びに行こうかと計画中です。
            ...
            また、アレルギー対応に対しては、欧米の方が日本よりも進んでいると良く聞きますが、オーストラリアではどうなのでしょうか。レストランでの対応メニューや食材等。', user_id: 20,country_id: 144, tag_id: 4,best_answer_id: 35},

...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference('Reaction.count') do
      post reactions_url, params: { reaction: { answer_id: @reaction.answer_id, body: @reaction.body, user_id: @reaction.user_id } }
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { answer_id: @reaction.answer_id, body: @reaction.body, user_id: @reaction.user_id } }
